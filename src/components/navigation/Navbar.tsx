...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky border-gray-200 bg-white">
          ...
          <div className="hidden w-full lg:block lg:w-auto" id="navbar-default">
            <ul className="navbar-nav block w-full md:w-auto lg:flex lg:space-x-2">
              ...
              <li className="flex items-center">
                <button
                  type="button"
                  className="me-2 rounded-lg border border-gray-200 bg-[#E6DDD0] px-5 py-2.5 text-sm font-medium text-[#66491C] focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 "
                >
                  Đặt lịch ngay
                </button>
              </li>
          ...
          <div className="block w-full lg:hidden lg:w-auto" id="navbar-default">
            <ul className="navbar-nav block w-full md:w-auto lg:flex lg:space-x-2">
              ...
              <li className="flex items-center justify-center p-2 text-center">
                <button
                  type="button"
                  className="w-80 rounded-lg border border-gray-200 bg-[#E6DDD0] px-5 py-2.5 text-sm font-medium text-[#66491C] focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 "
                >
                  Đặt lịch ngay
                </button>
              </li>
