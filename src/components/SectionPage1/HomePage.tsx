    ...
    <div className="overflow-hidden">
      ...
      <LazyLoad>
        ...
        <section className="w-full mx-auto mb-32 max-w-screen-xl 1280:px-[4rem]">
          ...
          <div className="mb-14">
            <motion.p
              className="text-center text-20px font-normal text-dark-200 1024px:text-16px"
              initial="hide"
              whileInView="show"
              viewport={{ once: true }}
              exit="hide"
            ...
            >
              MelMel Brows là đơn vị phun xăm thẩm mỹ thành lập từ 2016 bởi
              Grand Master Lư Yến Thanh. Với thế mạnh về kỹ năng và kinh nghiệm
              trải dài đến tận An Giang, MelMel Brows chuyên xoá sửa và khắc
              phục ca khó
            </motion.p>
          </div>
          <div className="hidden 475px:block">
            {contentPage1.map((i, idx) => {
              return (
                <div key={idx} className="flex items-center gap-[1rem] mb-4">
                  <Image src={i.img} alt="" />
