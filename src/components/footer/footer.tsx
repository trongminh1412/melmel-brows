...
const Footer = () => (
  <>
    <Background className="bg-[#E6DDD0]">
      <section className=" mx-auto max-w-screen-xl py-12  475px:px-[2rem]">
        <Row gutter={[20, 20]}>
          ...
          <Col xs={24} sm={24} md={24} lg={5}>
            <div className="text-[18px] font-bold leading-[26px] text-left text-[#66491c] mb-8">
              ĐỊA CHỈ
            </div>
            <Row>
              <Col span={2}>
              ...
              <Col span={22}>
                <div className="text-[16px] font-normal leading-[26px] text-left text-[#453113]">
                  {' '}
                  42 Huỳnh Khương Ninh, Đa Kao, Quận 1, Thành phố Hồ Chí Minh
                  70000
                </div>
              </Col>
              <Col span={2}>
          ...
          <Col xs={24} sm={24} md={24} lg={5}>
            ...
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 2: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 3: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 4: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 5: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 6: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
              Thứ 7: 10:00 AM - 06:00 PM
            </div>
            <div className="text-[16px] font-normal leading-[24.32px] text-left text-[#453113] mb-[1rem]">
          ...
          <Col xs={24} sm={24} md={24} lg={5}>
            ...
            <div className="text-[16px] font-normal leading-[26px] text-left text-[#453113]">
              Luôn cập nhật những tin tức mới nhất của chúng tôi, nhận các ưu
              đãi độc quyền và hơn thế nữa.
            </div>
            <div className="bg-[#ffffff] border rounded-[8px] p-[10px] mt-10">
              <button className="w-full">
                <span className="text-[18px] font-bold leading-[26px] text-left text-[#66491c]">
                  Đăng kí ngay
                </span>
              </button>
            </div>
    ...
    <section>
      <div className="text-center text-[18px] font-normal text-[#272B2F] leading-[28.08px] p-10">
        © Melmel Brows 2023. Website built by LINK.
      </div>
    </section>
  </>
);
